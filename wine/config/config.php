...
(
    'DIETL-ONLINE.COM' => array(
        'wine' => array
        (
            'tables'      => array('tl_wine'),
            //'table'       => array('TableWizard', 'importTable'),
            //'list'        => array('ListWizard', 'importList'),
            'icon' => 'system/modules/wine/assets/images/apps-wine-icon.png'
        )
    )));
 ...
 */
$GLOBALS['FE_MOD']['wine'] = array
(
    //'wine_list' => 'do_wine_fe',
    //'wine_details'  => 'ModuleWineDetails'
);
...
/* $GLOBALS['TL_MODELS'] = array
 (
    'do_wine'       => 'dietl_online\WineModel',
 );
 * 
 */
...
//$GLOBALS['TL_HOOKS']['replaceInsertTags'][] = array('dietl_online\wine\wine_frontend', 'Wine_Details');
$GLOBALS['TL_HOOKS'] = array
(
    /*
    'replaceInsertTags' => array
    (
       array('dietl_online\wine\wine_frontend', 'Wine_Details')
    )
     * 
     */
 );
...
$GLOBALS['RESTFUL_WEBSERVICES']['ROUTING']['wine'] = array
(
